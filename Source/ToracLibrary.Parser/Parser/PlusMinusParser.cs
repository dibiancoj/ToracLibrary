...
namespace ToracLibrary.Parser.Parser
{
 ...
 {
     ********started out using this for the plus - minus parser. To add * and / i had to change the math formula to calculate (orders of operation). This got left behind. leaving this in here for another example of how to loop through and parse ********
