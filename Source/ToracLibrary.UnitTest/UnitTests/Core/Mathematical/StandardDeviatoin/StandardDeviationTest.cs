...
namespace ToracLibrary.UnitTest.Core
{
    ...
    public class StandardDeviationTest
    {
        ...
        public void StandardDeviationTest1()
        {
            ...
            Assert.Equal(44.34210439550904, StandardDeviationCalculation.CalculateStandardDeviationHelper(BaseLineData));
        }
        ...
        public void StandardDeviationTest2()
        {
            ...
            //go check the results now
            Assert.Equal(87.329217656649419, StandardDeviationCalculation.CalculateStandardDeviationHelper(BaseLineData));
        }
